  ...
  <div class="row">
    <div class="col-md-6">
      <ul class="list-group">
        ...
        <li class="list-group-item">{{-- Domingo 9 --}} Agosto Duatlón Bragado (Bragado)</li>
      </ul>
    </div>
    <div class="col-md-6">
      <ul class="list-group">
        <li class="list-group-item active">Atletismo Bragado</li>
        <li class="list-group-item">{{-- Domingo 19 --}} Julio 15km de Bragado al Mundo</li>
        <li class="list-group-item">{{-- Domingo 6 --}} Septiembre posta 2 x 4km Brgado</li>
      </ul>
      <hr>
      <ul class="list-group">
        <li class="list-group-item active">{{-- Duatlón 5 --}} ciudades</li>
        <li class="list-group-item">{{-- Domingo 22 --}} Noviembre Duatlón cinco ciudades etapa Bragado</li>
      </ul>
    </div>   
  </div>
</section>